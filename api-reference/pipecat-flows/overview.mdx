...
Define either kind as a direct function, or — for advanced usage — with a [`FlowsFunctionSchema`](/api-reference/pipecat-flows/types#flowsfunctionschema). See the [Functions guide](/pipecat/flows/functions).
