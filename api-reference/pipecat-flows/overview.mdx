...
| ----------------- | --------------------- | -------------------------------- |
| OpenAI            | Function calling      | `uv add "pipecat-ai[openai]"`    |
| OpenAI-compatible | Function calling      | Provider-specific (see below)    |
| Anthropic         | Native tools          | `uv add "pipecat-ai[anthropic]"` |
| Google Gemini     | Function declarations | `uv add "pipecat-ai[google]"`    |
| AWS Bedrock       | Anthropic-compatible  | `uv add "pipecat-ai[aws]"`       |
