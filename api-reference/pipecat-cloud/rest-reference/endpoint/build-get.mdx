---
title: "Get Build"
"og:title": "Get Build - Pipecat Cloud"
description: "GET /builds/{buildId} returns the current status and details of a specific Pipecat Cloud build."
...
<Note>
  Once your build succeeds, use the Pipecat CLI to deploy your agent. The CLI
  will automatically use the built image.
</Note>
