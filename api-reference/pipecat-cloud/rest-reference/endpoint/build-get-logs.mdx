...
"og:title": "Get Build Logs - Pipecat Cloud"
description: "GET /builds/{buildId}/logs returns the build logs for a specific Pipecat Cloud build."
...
<Note>
  Logs may be empty if the build was just created and hasn't started executing
  yet. Continue polling until logs appear or the build completes.
</Note>
