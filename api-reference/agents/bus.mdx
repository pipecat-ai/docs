...
In-process bus that delivers messages via priority queues. This is the default bus used by [`AgentRunner`](/api-reference/agents/agent-runner) when no bus is provided.
