...
| Parameter | Type                                                      | Description             |
| --------- | --------------------------------------------------------- | ----------------------- |
| `message` | [`BusMessage`](/api-reference/agents/messages) | The bus message to send |
...
| Parameter | Type                                                      | Description                |
| --------- | --------------------------------------------------------- | -------------------------- |
| `message` | [`BusMessage`](/api-reference/agents/messages) | The bus message to publish |
...
In-process bus that delivers messages via priority queues. This is the default bus used by [`PipelineRunner`](/api-reference/agents/agent-runner) when no bus is provided.
...
<ParamField path="serializer" type="MessageSerializer | None" default="None">
  The
  [`MessageSerializer`](/api-reference/agents/serializers#messageserializer)
