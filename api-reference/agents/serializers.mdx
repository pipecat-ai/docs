...
| --------- | --------------------------------------------------------- | ---------------------------- |
| `message` | [`BusMessage`](/api-reference/agents/messages) | The bus message to serialize |
...
This is the default serializer used by [`RedisBus`](/api-reference/agents/bus#redisbus) and the [proxy agents](/api-reference/agents/proxy-agents).
