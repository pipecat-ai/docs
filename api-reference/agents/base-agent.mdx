...
| Parameter | Type                                                                      | Description                       |
| --------- | ------------------------------------------------------------------------- | --------------------------------- |
| `data`    | [`AgentReadyData`](/api-reference/agents/types#agentreadydata) | Information about the ready agent |
...
| Parameter | Type                                                                      | Description                 |
| --------- | ------------------------------------------------------------------------- | --------------------------- |
| `data`    | [`AgentErrorData`](/api-reference/agents/types#agenterrordata) | Information about the error |
...
**Returns:** A [`TaskContext`](/api-reference/agents/types#taskcontext) to use with `async with`.
...
**Returns:** A [`TaskGroupContext`](/api-reference/agents/types#taskgroupcontext) to use with `async with`.
...
| `status`   | [`TaskStatus`](/api-reference/agents/types#taskstatus) | `COMPLETED` | Completion status            |
