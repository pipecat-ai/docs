...
- **With a coding agent** like Claude Code or Codex. Run `pipecat init my-bot`, open the project in your agent, and it scaffolds and extends the app for you. On this path `init` also writes `GETTING_STARTED.md`, a developer guide for [setting up the Pipecat Context Hub](/api-reference/context-hub) and prompting your agent.
