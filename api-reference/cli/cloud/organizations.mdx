...
A key held by a region cannot be revoked on its own while the region exists, because it is the cluster's credential for pulling images. The region renews it, and deleting the region revokes it.
