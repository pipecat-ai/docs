...
<ParamField
  ...
  docs](/api-reference/utilities/audio/krisp-filter) and [`NoisereduceFilter()`
  reference docs](/api-reference/utilities/audio/noisereduce-filter)` for more
  information.
</ParamField>
...
<ParamField path="vad_analyzer" type="VADAnalyzer | None" default="None">
  ...
  [SileroVADAnalyzer](/api-reference/utilities/audio/silero-vad-analyzer).
</ParamField>
...
See [update_transcription](https://reference-python.daily.co/api_reference.html#daily.CallClient.update_transcription) for more details.
