...
"og:title": "Daily WebRTC Transport - C++ SDK"
description: "The Daily transport for the Pipecat C++ SDK: real-time WebRTC audio and video in native applications on Daily's infrastructure."
---
