...
"og:title": "PipecatClient Constructor - JavaScript SDK"
description: "Construct a PipecatClient from @pipecat-ai/client-js: transport selection, callbacks, and configuration options."
---
