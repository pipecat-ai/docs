...
<CardGroup cols={2}>
  <Card
    ...
    title="Demo"
    icon="play"
    href="https://github.com/pipecat-ai/pipecat-client-web-transports/tree/gemini-live-websocket-transport-v1.5.8/examples/directToLLMTransports"
  >
  ...
  <Card
    ...
    title="Source"
    icon="github"
    href="https://github.com/pipecat-ai/pipecat-client-web-transports/tree/gemini-live-websocket-transport-v1.5.8/transports/gemini-live-websocket-transport"
  >
    `GeminiLiveWebsocketTransport`
  </Card>
</CardGroup>
