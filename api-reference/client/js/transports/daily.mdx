...
"og:title": "Daily WebRTC Transport - JavaScript SDK"
sidebarTitle: "Daily"
description: "DailyTransport for the Pipecat JavaScript SDK: WebRTC audio and video on Daily's infrastructure, wrapping a Daily-JS call client."
---
