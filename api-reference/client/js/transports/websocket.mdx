...
"og:title": "WebSocket Transport - JavaScript SDK"
sidebarTitle: "WebSocket"
description: "WebSocketTransport for the JavaScript SDK: a lightweight, purely WebSocket-based connection between clients and a Pipecat bot."
---
