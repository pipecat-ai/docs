...
"og:title": "Small WebRTC Transport - JavaScript SDK"
sidebarTitle: "Small WebRTC"
description: "SmallWebRTCTransport for the JavaScript SDK: peer-to-peer WebRTC to a Pipecat bot with no third-party WebRTC provider."
---
...
- Up to 3 reconnection attempts for transient connection failures (network errors, 5xx responses); authentication and validation errors (4xx responses) fail immediately without retry
