...
"og:title": "Client Methods - JavaScript SDK"
description: "PipecatClient methods for starting bots, managing sessions, sending messages, and controlling devices in the JavaScript SDK."
---
