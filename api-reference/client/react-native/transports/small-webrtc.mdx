...
"og:title": "Small WebRTC Transport - React Native SDK"
sidebarTitle: "Small WebRTC"
description: "SmallWebRTCTransport for the React Native SDK: peer-to-peer WebRTC to a Pipecat bot with no third-party WebRTC provider."
---
