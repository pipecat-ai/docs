...
description: "The Pipecat iOS SDK: a Swift client library for building voice and multimodal AI applications on iOS."
---
...
<CardGroup cols={2}>
  <Card
    title="API Reference"
    icon="book"
    href="/api-reference/client/ios/api-reference"
  >
