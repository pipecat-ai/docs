...
"og:title": "Small WebRTC Transport - iOS SDK"
sidebarTitle: "Small WebRTC"
description: "SmallWebRTCTransport for the iOS SDK: peer-to-peer WebRTC between Swift clients and a Pipecat bot, no third-party provider."
---
