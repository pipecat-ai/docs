...
"og:title": "OpenAI Realtime WebRTC Transport - iOS SDK"
sidebarTitle: "OpenAI Realtime"
description: "OpenAIRealTimeWebRTCTransport for the Pipecat iOS SDK: connect Swift apps directly to the OpenAI Realtime API over WebRTC."
---
