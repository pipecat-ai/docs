...
"og:title": "Gemini Live WebSocket Transport - iOS SDK"
sidebarTitle: "Gemini Live"
description: "The Gemini Live WebSocket transport for the Pipecat iOS SDK: connect Swift apps directly to Google's Gemini Live service."
---
