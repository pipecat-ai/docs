...
"og:title": "Small WebRTC Transport - Android SDK"
sidebarTitle: "Small WebRTC"
description: "The Small WebRTC transport for the Android SDK: direct peer-to-peer WebRTC between Kotlin clients and a Pipecat bot."
---
