...
"og:title": "Gemini Live WebSocket Transport - Android SDK"
sidebarTitle: "Gemini Live"
description: "The Gemini Live WebSocket transport for the Pipecat Android SDK: connect Kotlin apps directly to Google's Gemini Live service."
---
