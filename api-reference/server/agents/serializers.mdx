...
| --------- | --------------------------------------------------------- | ---------------------------- |
| `message` | [`BusMessage`](/api-reference/server/agents/messages) | The bus message to serialize |
...
This is the default serializer used by [`RedisBus`](/api-reference/server/agents/bus#redisbus) and the [proxy agents](/api-reference/server/agents/proxy-agents).
