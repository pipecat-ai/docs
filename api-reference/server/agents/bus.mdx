...
| Parameter | Type                                                      | Description             |
| --------- | --------------------------------------------------------- | ----------------------- |
| `message` | [`BusMessage`](/api-reference/server/agents/messages) | The bus message to send |
...
| Parameter | Type                                                      | Description                |
| --------- | --------------------------------------------------------- | -------------------------- |
| `message` | [`BusMessage`](/api-reference/server/agents/messages) | The bus message to publish |
...
In-process bus that delivers messages via priority queues. This is the default bus used by [`PipelineRunner`](/api-reference/server/agents/agent-runner) when no bus is provided.
...
<ParamField path="serializer" type="MessageSerializer | None" default="None">
  The
  [`MessageSerializer`](/api-reference/server/agents/serializers#messageserializer)
  for encoding/decoding messages. Defaults to
  [`JSONMessageSerializer`](/api-reference/server/agents/serializers#jsonmessageserializer).
</ParamField>
