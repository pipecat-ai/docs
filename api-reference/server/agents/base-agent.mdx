...
A `BaseWorker` connects to a [`WorkerBus`](/api-reference/server/agents/bus#workerbus), registers itself in the shared registry, accepts activation/deactivation, and exchanges job requests/responses with other agents. Agents that need to run a Pipecat pipeline use a concrete subclass like [`LLMWorker`](/api-reference/server/agents/llm-agent), while `BaseWorker` itself operates purely through bus messages (e.g. coordinators, orchestrators).
...
<Note>
  ...
  [`PipelineRunner.add_workers()`](/api-reference/server/agents/agent-runner#add-workers),
...
| Parameter | Type                                                             | Description                       |
| --------- | ---------------------------------------------------------------- | --------------------------------- |
| `data`    | [`WorkerReadyData`](/api-reference/server/agents/types#workerreadydata) | Information about the ready agent |
...
| Parameter | Type                                                             | Description                 |
| --------- | ---------------------------------------------------------------- | --------------------------- |
| `data`    | [`WorkerErrorData`](/api-reference/server/agents/types#workererrordata) | Information about the error |
...
**Returns:** A [`JobContext`](/api-reference/server/agents/types#jobcontext) to use with `async with`.
...
**Returns:** A [`JobGroupContext`](/api-reference/server/agents/types#jobgroupcontext) to use with `async with`.
...
| `status`   | [`JobStatus`](/api-reference/server/agents/types#jobstatus) | `COMPLETED` | Completion status            |
...
**Returns:** The created [`JobGroup`](/api-reference/server/agents/types#jobgroup).
...
| Parameter | Type                                                     | Description                |
| --------- | -------------------------------------------------------- | -------------------------- |
| `message` | [`BusMessage`](/api-reference/server/agents/messages) | The bus message to process |
