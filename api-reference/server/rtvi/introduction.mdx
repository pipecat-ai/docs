...
You can customize RTVI behavior through `PipelineWorker` parameters:
...
<CardGroup cols={2}>
  <Card
    title="RTVIProcessor"
    icon="gear"
    href="/api-reference/server/rtvi/rtvi-processor">
  ...
  <Card
    ...
    href="/api-reference/server/rtvi/rtvi-observer">
