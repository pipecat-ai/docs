...
description: "Detect and handle idle Pipecat pipelines with no bot or user activity, and shut them down automatically."
---
...
You can configure idle detection behavior when creating a `PipelineWorker`:
