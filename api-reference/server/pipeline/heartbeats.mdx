...
description: "Monitor Pipecat pipeline health with heartbeat frames that verify frames still flow end to end."
---
...
```
WARNING    PipelineWorker#1: heartbeat frame not received for more than 5.0 seconds
```
