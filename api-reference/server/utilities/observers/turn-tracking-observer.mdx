...
description: "TurnTrackingObserver tracks conversation turns in a Pipecat pipeline and emits turn started and ended events."
---
...
<ParamField path="turn_end_timeout_secs" type="float" default="2.5">
  Timeout in seconds after bot stops speaking before automatically ending the
  turn.
</ParamField>

<ParamField path="max_frames" type="int | None" default="None" deprecated>
  **Deprecated since 1.12.0.** No replacement. The observer receives each frame
  once. Will be removed in 2.0.0.
</ParamField>
