...
<Note>
  Proposal-driven turns landed after v1.7.0. On v1.7.0 and earlier the service
  pushed the turn frames and broadcast the interruption itself, and
  `ExternalUserTurnStrategies` had no `enable_interruptions` parameter.
</Note>
