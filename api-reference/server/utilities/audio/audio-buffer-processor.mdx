...
<Warning>
**Deprecated since 1.8.0**. Use `on_user_turn_audio` instead. Will be removed in 2.0.0.
</Warning>
...
<Warning>
**Deprecated since 1.8.0**. Use `on_bot_turn_audio` instead. Will be removed in 2.0.0.
</Warning>
