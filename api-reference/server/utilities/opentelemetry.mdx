...
- `gen_ai.usage.audio.input_tokens`: Audio prompt tokens (OpenAI Realtime)
- `gen_ai.usage.audio.output_tokens`: Audio completion tokens (OpenAI Realtime)
- `gen_ai.usage.audio.cache_read.input_tokens`: Cached audio tokens (OpenAI Realtime)
...
For realtime models (OpenAI Realtime), additional audio token breakdown is captured:
