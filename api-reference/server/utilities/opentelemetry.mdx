...
2. **Enable tracing in your PipelineWorker**
...
- [LangSmith Tracing Example](https://github.com/pipecat-ai/pipecat-examples/tree/main/open-telemetry/langsmith) - Uses HTTP exporter with LangSmith for LLM-focused observability
- [SigNoz Tracing Example](https://github.com/pipecat-ai/pipecat-examples/tree/main/open-telemetry/signoz) - Uses no-code auto instrumentation with OpenTelemetry
- [MLflow Integration Guide](/api-reference/server/services/analytics/mlflow) - Uses HTTP exporter with MLflow for trace visualization and evaluation
...
### HTTP OTLP Exporter (for Langfuse, LangSmith, MLflow, SigNoz, etc.)
...
See our [Langfuse example](https://github.com/pipecat-ai/pipecat-examples/tree/main/open-telemetry/langfuse) for details on configuring this exporter, or the [MLflow integration guide](/api-reference/server/services/analytics/mlflow) for sending traces to MLflow.
...
- `gen_ai.usage.audio.input_tokens`: Number of audio prompt tokens (realtime models)
- `gen_ai.usage.audio.output_tokens`: Number of audio completion tokens (realtime models)
- `gen_ai.usage.audio.cache_read.input_tokens`: Number of cached audio tokens (realtime models)
- `metrics.ttfb`: Time to first byte in seconds
...
- `gen_ai.usage.cache_read.input_tokens`: Cached prompt tokens (when applicable)
- `gen_ai.usage.audio.input_tokens`: Audio prompt tokens (Gemini Live, OpenAI Realtime)
...
For realtime models (Gemini Live, OpenAI Realtime), additional audio token breakdown is captured:
...
- [LangSmith OpenTelemetry Documentation](https://docs.langchain.com/langsmith/trace-with-pipecat)
