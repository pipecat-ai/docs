---
title: "Exceptions"
"og:title": "Exceptions - Pipecat Server"
description: "Error types for Pipecat job coordination: JobError and the exceptions raised by JobContext-based single-agent jobs."
---
