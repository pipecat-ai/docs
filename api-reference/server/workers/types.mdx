...
| `label`       | `str \| None`   | `None`  | Human-readable description, e.g. `"Research: Radiohead"`. A [`UIWorker`](/api-reference/server/workers/ui-worker) titles the client's progress card with it |
