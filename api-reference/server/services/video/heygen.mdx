...
- **Video encoding**: `LiveAvatarNewSessionRequest` defaults to H264 video encoding. LiveAvatar has deprecated VP8; to use VP8 while it remains supported, pass `video_settings=VideoSettings(encoding=VideoEncoding.VP8)` explicitly.
