---
title: "Simli Video Avatar"
sidebarTitle: "Simli"
description: "SimliVideoService creates real-time Simli AI avatar video over WebRTC, animated by your Pipecat agent's audio."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/video-avatar-simli-video-service.py"
  >
