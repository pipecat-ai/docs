---
title: "Future AGI Observability"
sidebarTitle: "Future AGI"
description: "traceAI-pipecat adds OpenTelemetry tracing and evaluation instrumentation from Future AGI to Pipecat applications."
---
...
```bash
uv add traceAI-pipecat
```

For gRPC transport, also install the gRPC extras:

```bash
uv add "fi-instrumentation[grpc]"
```
