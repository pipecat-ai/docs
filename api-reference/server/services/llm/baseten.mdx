...
description: "BasetenLLMService connects to Baseten Model APIs and dedicated deployments, inheriting OpenAILLMService's streaming and tools."
---
...
The default model is `moonshotai/Kimi-K2.6`, which streams visible content immediately for low time-to-first-word.
