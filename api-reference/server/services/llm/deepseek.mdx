...
<ParamField path="thinking" type="DeepSeekLLMService.ThinkingConfig | None" default="NOT_GIVEN">
  Thinking mode configuration. When unset, DeepSeek's own default applies: thinking enabled at "high" reasoning effort.
