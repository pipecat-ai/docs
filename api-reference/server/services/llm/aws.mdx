...
description: "AWSBedrockLLMService runs Amazon Bedrock foundation models, including Claude and Amazon Nova, with streaming and function calling."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/function-calling/function-calling-aws.py"
  >
