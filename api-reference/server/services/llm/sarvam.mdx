...
title: "Sarvam AI LLM"
sidebarTitle: "Sarvam"
description: "SarvamLLMService generates chat completions on Sarvam AI's OpenAI-compatible API with streaming and function calling."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/function-calling/function-calling-sarvam.py"
  >
...
3. **Model**: The service supports `deepseekv4-flash`, `gemma4`, `glm5.2`, `sarvam-105b`, and `sarvam-105b-conversations` models
...
<ParamField path="base_url" type="str | None" default="None">
  Sarvam OpenAI-compatible base URL. When `None`, resolved from the model: `/v1`
...
| ------------------- | ---------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `model`             | `str`                              | `"sarvam-105b"` | Sarvam model identifier. Supported models: `deepseekv4-flash`, `gemma4`, `glm5.2`, `sarvam-105b`, `sarvam-105b-conversations`. |
...
- **Model-Specific Capabilities**:
  ...
  - **Reasoning**: `deepseekv4-flash`, `gemma4`, `glm5.2`, and `sarvam-105b` support the `reasoning_effort` parameter. Using it with `sarvam-105b-conversations` will return an error.
