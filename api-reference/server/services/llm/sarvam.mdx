...
3. **Model**: The service uses the `sarvam-105b` model, the only chat model currently supported by Sarvam's API
...
| ------------------- | ---------------------------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| `model`             | `str`                              | `"sarvam-105b"` | Sarvam model identifier. Only `sarvam-105b` is currently supported.                                 |
