...
description: "SambaNovaLLMService connects to SambaNova language models through an OpenAI-compatible interface with streaming support."
---
...
- SambaNova does not support OpenAI's `service_tier` parameter.
