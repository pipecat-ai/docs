---
title: "Fireworks AI LLM"
sidebarTitle: "Fireworks AI"
description: "FireworksLLMService accesses Fireworks AI language models with streaming and function calling via an OpenAI-compatible API."
---
