...
description: "MistralLLMService accesses Mistral language models through an OpenAI-compatible interface, inheriting OpenAILLMService streaming."
---
...
1. **Mistral Account**: Sign up through the [Mistral Studio](https://mistral.ai/)
