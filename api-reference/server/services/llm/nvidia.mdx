---
title: "NVIDIA NIM LLM"
sidebarTitle: "NVIDIA NIM"
description: "NvidiaLLMService accesses NVIDIA NIM (NVIDIA Inference Microservice) models via an OpenAI-compatible interface."
---
...
<ParamField path="api_key" type="str | None" default="None">
  ...
  (`https://integrate.api.nvidia.com/v1`). Not needed for local NIM deployments.
</ParamField>
...
>
  Base URL for NIM API endpoint. Defaults to NVIDIA's cloud endpoint. For local
  deployments, pass the local address (e.g., `http://localhost:8000/v1`).
</ParamField>
