...
| `thinking`              | `AnthropicThinkingConfig` | `NOT_GIVEN` | Thinking configuration. See [AnthropicThinkingConfig](#anthropicthinkingconfig) below. |
