...
title: "OpenAI LLM"
sidebarTitle: "OpenAI"
description: "OpenAILLMService for GPT chat completions: streaming responses, function calling, vision input, and OpenAI-compatible base URLs."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/getting-started/07-function-calling.py"
  >
