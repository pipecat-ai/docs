...
title: "Crusoe LLM"
sidebarTitle: "Crusoe"
description: "CrusoeLLMService generates chat completions on Crusoe Cloud's Managed Inference API, OpenAI-compatible with streaming support."
---
...
| ------------------- | ------- | ------------------------ | -------------------------------------------------------------------------------------- |
| `model`             | `str`   | `"openai/gpt-oss-120b"` | Crusoe model identifier. Check Crusoe Cloud for available models.                      |
