...
title: "Nebius LLM"
sidebarTitle: "Nebius"
description: "NebiusLLMService generates chat completions on Nebius Token Factory's OpenAI-compatible API with streaming responses."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/function-calling/function-calling-nebius.py"
  >
