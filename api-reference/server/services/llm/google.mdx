...
| `tool_call_text_policy` | `ToolCallTextPolicy`   | `"preserve"`       | Whether to preserve text emitted after a tool call. Set to `"suppress_after_tool_call"` to omit that text from the current response. _(Inherited from base settings.)_ |
