...
<ParamField path="stream_idle_timeout_secs" type="float | None" default="20.0">
  ...
  wait spans the whole round trip including any thinking the model does before it
  emits anything; raise this for models configured to think at length. Set to
