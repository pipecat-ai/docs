...
sidebarTitle: "Google"
description: "Google Cloud TTS with GoogleTTSService (low-latency streaming), GoogleHttpTTSService, and GeminiTTSService for Gemini TTS models."
---
...
<ParamField
  ...
  deprecated
>
  Gemini TTS model to use, named as the chosen backend names it. Cloud
  Text-to-Speech accepts `"gemini-3.1-flash-tts-preview"`,
  `"gemini-2.5-flash-tts"`, `"gemini-2.5-flash-lite-preview-tts"`, and
  `"gemini-2.5-pro-tts"`. The Gemini API accepts
  `"gemini-3.1-flash-tts-preview"`, `"gemini-2.5-flash-preview-tts"`, and
  `"gemini-2.5-pro-preview-tts"`. The default (`"gemini-3.1-flash-tts-preview"`)
  works on both backends. _Deprecated in v0.0.105. Use
...
- **Gemini TTS model names**: Model names differ by backend. Cloud Text-to-Speech accepts `gemini-3.1-flash-tts-preview`, `gemini-2.5-flash-tts`, `gemini-2.5-flash-lite-preview-tts`, and `gemini-2.5-pro-tts`. The Gemini API accepts `gemini-3.1-flash-tts-preview`, `gemini-2.5-flash-preview-tts`, and `gemini-2.5-pro-preview-tts`. The default (`gemini-3.1-flash-tts-preview`) works on both.
