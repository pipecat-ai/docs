...
sidebarTitle: "Hume"
description: "HumeTTSService generates expressive TTS with Hume AI's Octave models: context-aware pitch, speed, emotion, and word timestamps."
---
...
<ParamField path="params" type="InputParams" default="None" deprecated>
  Runtime-configurable synthesis controls. See [Settings](#settings)
  below.
...
| `temperature`      | `float`           | `NOT_GIVEN` | Sampling temperature for speech generation. Higher values increase variation, lower values increase consistency. |
