---
title: "Inworld Text-to-Speech"
sidebarTitle: "Inworld"
description: "TTS with InworldTTSService (real-time WebSocket) and InworldHttpTTSService, running Inworld AI's TTS-2 and TTS-1.5 models."
---
...
- **Pronunciation hints**: Inworld reads IPA between slashes (e.g., `/kriːt/`), one word per pair of slashes. Only English IPA symbols are supported.
