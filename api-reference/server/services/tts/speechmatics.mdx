---
title: "Speechmatics Text-to-Speech"
sidebarTitle: "Speechmatics"
description: "SpeechmaticsTTSService provides production-grade low-latency TTS, streaming 16kHz mono audio tuned for telephony voice agents."
---
...
<ParamField path="params" type="InputParams" default="None" deprecated>
  Runtime-configurable service settings. See [Settings](#settings) below.
