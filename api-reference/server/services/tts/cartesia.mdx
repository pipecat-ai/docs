...
- **Chinese and Japanese language support**: For Chinese and Japanese, the service combines individual characters from timestamp messages into meaningful units without spaces. Korean preserves word boundaries with normal spacing.
