---
title: "Simplismart Text-to-Speech"
sidebarTitle: "Simplismart"
description: "SimplismartHttpTTSService streams raw PCM TTS audio from Simplismart's /tts API endpoint for low-latency synthesis."
---
