---
title: "Deepdub Text-to-Speech"
sidebarTitle: "Deepdub"
description: "DeepdubTTSService streams real-time TTS over Deepdub AI's WebSocket API, extending InterruptibleTTSService for interruption handling."
---
