...
description: "FishAudioTTSService streams real-time TTS through Fish Audio's WebSocket API with custom voice models and prosody control."
---
...
1. **Fish Audio Account**: Sign up at [Fish Audio Console](https://fish.audio/auth/)
