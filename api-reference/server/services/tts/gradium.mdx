...
description: "GradiumTTSService streams expressive TTS over Gradium's WebSocket API with instant voice cloning and low-latency inference."
---
...
<ParamField path="url" type="str" default="wss://api.gradium.ai/api/speech/tts">
