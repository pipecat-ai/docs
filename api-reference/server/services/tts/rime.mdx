...
sidebarTitle: "Rime"
description: "TTS with RimeTTSService (WebSocket streaming with word timing and interruptions) and RimeHttpTTSService for batch synthesis."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book"
    href="https://docs.rime.ai/api-reference/coda/websockets-json"
  >
...
<Tip>
  ...
  `replace_text` transform. See [Pronunciation
  Lexicons](/pipecat/fundamentals/pronunciation-lexicons).
</Tip>
