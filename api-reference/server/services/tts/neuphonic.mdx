---
title: "Neuphonic Text-to-Speech"
sidebarTitle: "Neuphonic"
description: "TTS with NeuphonicTTSService (real-time WebSocket streaming with interruptions) and NeuphonicHttpTTSService for HTTP synthesis."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book"
    href="https://docs.neuphonic.com/how-to-use-agents/"
  >
...
| `temperature` | `float \| None`   | `NOT_GIVEN` | Randomness in synthesis (0.0–1.0). Left to Neuphonic's default when unset. |
