---
title: "Lokutor Text-to-Speech"
sidebarTitle: "Lokutor"
description: "LokutorTTSService generates TTS over a persistent WebSocket connection to Lokutor's CPU-only speech synthesis API."
---
