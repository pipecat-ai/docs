---
title: "XTTS-vLLM Text-to-Speech"
sidebarTitle: "XTTS-vLLM"
description: "XTTSVLLMTTSService streams TTS from a self-hosted XTTSv2 + vLLM streaming server for low-latency open-model synthesis."
---
