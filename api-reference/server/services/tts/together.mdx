---
title: "Together AI Text-to-Speech"
sidebarTitle: "Together AI"
description: "TogetherTTSService streams real-time TTS over Together AI's WebSocket API with configurable voice and model options."
---
