---
title: "Groq Text-to-Speech"
sidebarTitle: "Groq"
description: "GroqTTSService delivers fast TTS from Groq's API with multiple voice options and configurable sample rates for voice agents."
---

## Overview

`GroqTTSService` provides fast text-to-speech synthesis using Groq's TTS API with multiple voice options. The service operates at a default 24kHz sample rate and supports various sample rates, offering efficient audio streaming for real-time applications with ultra-low latency.
...
<ParamField path="sample_rate" type="int" default="None">
  Audio sample rate. If None, uses default sample rate.
</ParamField>
