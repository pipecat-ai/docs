...
<ParamField path="sample_rate" type="int" default="None">
  Output sample rate in Hz. When `None`, uses the pipeline default. A rate
  Bland does not render (8000, 16000, 24000, 44100, 48000) is replaced with
  48000 and resampled by the output transport.
</ParamField>
...
<ParamField
  path="settings"
  type="BlandHttpTTSService.Settings"
  default="None"
>
