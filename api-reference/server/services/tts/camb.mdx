---
title: "Camb AI Text-to-Speech"
sidebarTitle: "Camb AI"
description: "CambTTSService streams high-quality TTS using Camb AI's MARS model family, with multiple model and voice options."
---
...
<ParamField path="params" type="InputParams" default="None" deprecated>
  Runtime-configurable voice settings. See [Settings](#settings) below.
