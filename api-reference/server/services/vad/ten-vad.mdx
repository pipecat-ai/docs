...
title: "TEN VAD"
sidebarTitle: "TEN"
description: "TenVadAnalyzer implements Pipecat's VADAnalyzer interface with the TEN VAD backend for voice activity detection."
---
...
```bash
uv add git+https://github.com/TEN-framework/ten-vad.git
```

Then install the integration:

```bash
uv add pipecat-ten-vad
```
