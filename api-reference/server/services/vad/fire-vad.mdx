---
title: "FireRed VAD"
sidebarTitle: "FireRed"
description: "FireVadAnalyzer provides streaming voice activity detection (VAD) for Pipecat using the FireRedVAD model."
---
