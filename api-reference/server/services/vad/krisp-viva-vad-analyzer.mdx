---
title: "Krisp VIVA VAD"
sidebarTitle: "Krisp VIVA"
description: "KrispVivaVadAnalyzer detects voice activity (VAD) using the Krisp VIVA SDK for accurate speech boundaries."
---
...
<ParamField path="params" type="VADParams" default="VADParams()">
  ...
  <Expandable title="properties">
    ...
    <ParamField path="min_volume" type="float" default="0.6">
      Minimum audio volume threshold for speech detection. Must be between 0 and 1. Volume is measured over a rolling 400ms window, which provides stable readings that are less affected by brief dips between phonemes.
    </ParamField>
