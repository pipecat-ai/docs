...
<ParamField path="agent_image_url" type="str" default="None">
  URL to an agent image. Provide exactly one of `agent_image_url`, `agent_id`,
  or `agent_image`.
</ParamField>

<ParamField path="agent_id" type="str" default="None">
  ID of a LemonSlice agent. Provide exactly one of `agent_image_url`,
  `agent_id`, or `agent_image`.
</ParamField>

<ParamField path="agent_image" type="PIL.Image.Image" default="None">
  PIL image uploaded as the agent image. Provide exactly one of
