---
title: "FastAPI WebSocket Transport"
sidebarTitle: "FastAPI WebSocket"
description: "FastAPIWebsocketTransport serves Pipecat sessions over WebSockets in FastAPI apps, pairing with telephony FrameSerializers."
---
