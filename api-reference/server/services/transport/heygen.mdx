---
title: "HeyGen Transport"
sidebarTitle: "HeyGen"
description: "HeyGenTransport joins your Pipecat bot to the same virtual room as a HeyGen avatar for interactive avatar sessions."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/video-avatar-heygen-transport.py"
  >
...
>
  ...
  See [LiveAvatar video
  settings](/api-reference/server/services/video/heygen#liveavatar-video-settings)
  for encoding and quality options.
</ParamField>
