...
| `participant_id` | `str` &#124; `None` | The sender's participant ID, or `None` for server SDK-sent packets |
...
| ----------- | ------------------ | ---------------------------------------------------------------------------------- |
| `transport` | `LiveKitTransport` | The transport instance                                                             |
| `data`      | `dict`             | DTMF data with keys `tone`/`digit` (str), `code` (int), and `participant_id` (str) |
