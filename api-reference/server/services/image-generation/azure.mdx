...
sidebarTitle: "Azure"
description: "AzureImageGenServiceREST generates images with Azure OpenAI's image API from text prompts in Pipecat pipelines."
---
...
<ParamField
  path="settings"
  type="AzureImageGenServiceREST.Settings"
  default="None"
>
