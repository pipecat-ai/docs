...
sidebarTitle: "OpenAI"
description: "OpenAIImageGenService generates images with OpenAI's DALL-E models from text prompts in Pipecat pipelines."
---
...
<ParamField
  path="settings"
  type="OpenAIImageGenService.Settings"
  default="None"
>
