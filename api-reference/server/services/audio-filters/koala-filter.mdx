---
title: "Koala Audio Filter"
sidebarTitle: "Koala"
description: "KoalaFilter reduces background noise in real-time audio using Picovoice Koala noise suppression in Pipecat pipelines."
---
