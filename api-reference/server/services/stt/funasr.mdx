---
title: "FunASR Speech-to-Text"
sidebarTitle: "FunASR"
description: "Offline STT with FunASRSTTService running SenseVoice models locally on CPU or GPU: multilingual, with strong Chinese support."
---
...
<Tip>
  No API keys required - FunASR runs entirely locally for complete privacy. Can
  run on CPU or GPU.
</Tip>
...
<ParamField path="settings" type="FunASRSTTService.Settings" default="None">
  ...
  [FunASRSTTSettings](#funasrsttsettings) below.
</ParamField>
