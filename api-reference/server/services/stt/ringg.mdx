---
title: "Ringg AI Speech-to-Text"
sidebarTitle: "Ringg AI"
description: "RinggSTTService streams STT through the official ringglabs Python SDK, which manages the WebSocket connection and event parsing."
---
