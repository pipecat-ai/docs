...
description: "Speech recognition with ElevenLabsRealtimeSTTService (live WebSocket streaming) and ElevenLabsSTTService for file-based STT."
---
...
| `no_verbatim`      | `bool`            | `None`        | Whether to drop filler words, false starts and non-speech sounds from the transcript. Supported by `scribe_v2` only. |
...
| `keyterms`                   | `list[str]`       | `None`  | List of key terms or phrases to bias transcription towards.                             |
| `no_verbatim`                | `bool`            | `None`  | Whether to drop filler words, false starts and non-speech sounds from the transcript.   |
...
| `filter_background_audio`    | `bool`            | `None`  | Whether ElevenLabs filters out background audio before transcription.                   |
