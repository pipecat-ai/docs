---
title: "Smallest AI Speech-to-Text"
sidebarTitle: "Smallest AI"
description: "SmallestSTTService provides real-time streaming STT through Smallest AI's Pulse model over the Waves WebSocket API."
---
...
| `keywords`            | `str`             | `""`          | Comma-separated `KEYWORD:INTENSIFIER` pairs to boost recognition of domain-specific words/phrases (e.g. `"Blackwell:2"`). |
