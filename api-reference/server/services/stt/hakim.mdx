---
title: "Hakim Speech-to-Text"
sidebarTitle: "Hakim"
description: "HakimSTTService provides Arabic-first realtime STT over a persistent WebSocket connection to Hakim's transcription API."
---
...
<Note>
  See the [source repository](https://github.com/tryHakimAI/hakim-pipecat) for
  the authoritative, up-to-date configuration options.
</Note>
