---
title: "NVIDIA Nemotron Speech-to-Text"
sidebarTitle: "NVIDIA Nemotron Speech"
description: "Real-time STT with NvidiaSTTService, NvidiaSegmentedSTTService, and a SageMaker variant, running NVIDIA Nemotron Speech models."
---
...
<ParamField
  path="settings"
  type="NvidiaSageMakerSTTService.Settings"
  default="None"
>
...
- **AWS SageMaker deployment required**: This service requires a deployed SageMaker endpoint running NVIDIA Nemotron ASR NIM. See the [deployment example](https://github.com/pipecat-ai/pipecat-examples/tree/main/deployment/aws-sagemaker-nvidia) for setup instructions.
