...
- **Automatic keepalive**: Sends silence over idle streams every 5 seconds (after 30 seconds of no audio) to prevent NVIDIA streaming ASR sessions from degrading during periods of no user speech.
