---
title: "Fal Wizper Speech-to-Text"
sidebarTitle: "Fal (Wizper)"
description: "FalSTTService transcribes speech segments with Fal's Wizper API, using VAD-segmented audio to cut STT cost and latency."
---
