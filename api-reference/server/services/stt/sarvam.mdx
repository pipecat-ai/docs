...
<ParamField path="settings" type="SarvamRealtimeSTTService.Settings" default="None">
  Runtime-updatable realtime settings. See [Realtime Settings](#realtime-settings) below.
</ParamField>

<ParamField path="should_interrupt" type="bool" default="True">
  Whether the bot should be interrupted when Sarvam detects user speech. Passed to the user turn strategies this service recommends.
</ParamField>
