...
<ParamField path="model" type="str" default="saaras:v4" deprecated>
  ...
  (advanced, supports mode and fine-grained VAD), `"saaras:v4"`
  (advanced, supports mode and fine-grained VAD, adds Global English support). *Deprecated in v0.0.105. Use
