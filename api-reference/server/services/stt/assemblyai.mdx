...
description: "Real-time STT with AssemblyAISTTService: WebSocket streaming, interim results, and end-of-turn detection for voice agents."
---
...
<ParamField path="should_interrupt" type="bool" default="True">
  ...
  AssemblyAI's built-in turn detection. The value is passed to the user turn
