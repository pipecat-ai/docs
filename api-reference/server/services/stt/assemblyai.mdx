...
| `language_code`                    | `str`                                                | `None`                | Customer-declared audio language as an ISO code (e.g., `"en"`, `"es"`, `"fr"`). On `universal-3-5-pro`, tier-1 codes (`"en"`, `"es"`, `"fr"`, `"de"`, `"it"`, `"pt"`) steer transcription toward that language. Other supported codes: `"tr"`, `"nl"`, `"sv"`, `"no"`, `"da"`, `"fi"`, `"hi"`, `"vi"`, `"ar"`, `"he"`, `"ja"`, `"ur"`, `"zh"`. Mutually exclusive with `language_detection`. Defaults to `None` (not sent; no steering). |
