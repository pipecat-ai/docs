---
title: "Groq Whisper Speech-to-Text"
sidebarTitle: "Groq (Whisper)"
description: "GroqSTTService runs VAD-segmented STT on Groq's hosted Whisper API, pairing Whisper accuracy with ultra-fast inference."
---
