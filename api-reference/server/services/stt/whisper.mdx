...
>
  ...
  `LARGE_V3_TURBO`. English-only models: `DISTIL_LARGE_V2`, `DISTIL_MEDIUM_EN`.
...
>
  ...
  Multilingual models: `TINY`, `MEDIUM`, `LARGE_V3`, `LARGE_V3_TURBO`,
  `LARGE_V3_TURBO_Q4` (quantized). English-only model: `DISTIL_LARGE_V3`.
...
| `initial_prompt` | `str \| None`     | `None`                   | Text prepended as preceding context to steer style, punctuation and spelling. |
