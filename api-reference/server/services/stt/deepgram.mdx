...
- **Connection readiness**: Audio frames arriving during the initial connection handshake are held and transcribed once the connection is ready, ensuring no words are lost even when someone starts speaking immediately as the session begins.
