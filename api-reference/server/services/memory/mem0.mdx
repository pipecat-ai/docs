...
| `api_version`           | `str \| None` | `None`                                              | **Deprecated in 1.4.0**. No longer used. Mem0 2.0.0 removed the `api_version`/`output_format` parameters from the client. Will be removed in 2.0.0. |
