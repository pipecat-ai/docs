...
<CardGroup cols={2}>
  ...
  <Card
    title="Memcode Guide"
    icon="book"
    href="https://memcode.in/docs?product=pipecat"
  >
...
PKCE, and dynamic client registration. Registration happens once per
deployment; authorization is completed once per Memcode account. Store rotating
