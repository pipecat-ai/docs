---
title: "OpenAI Live"
description: "OpenAILiveLLMService connects Pipecat to OpenAI's GPT-Live API for full-duplex speech-to-speech conversation with delegated tools."
---
...
| -------------------- | ----- | ----------- | -------------------------------------------------------------------------------------------- |
| `model`              | `str` | `NOT_GIVEN` | GPT-Live model identifier. _(Inherited from base settings.)_                                 |
| `system_instruction` | `str` | `NOT_GIVEN` | Instructions for the GPT-Live model. _(Inherited from base settings.)_                       |
