...
description: "AWSNovaSonicLLMService provides real-time speech-to-speech (S2S) conversation with AWS's Nova Sonic model."
---
...
<ParamField path="region" type="str" required>
  ...
  (default): `"us-east-1"`, `"us-west-2"`, `"eu-north-1"`, `"ap-northeast-1"`.
  Supported regions for Nova Sonic (older model): `"us-east-1"`, `"eu-north-1"`,
  `"ap-northeast-1"`.
</ParamField>
...
<ParamField
  path="tools"
  type="ToolsSchema | List[FunctionSchema | DirectFunction]"
  default="None"
>
...
<ParamField
  path="session_continuation"
  type="SessionContinuationParams"
  default="None"
>
