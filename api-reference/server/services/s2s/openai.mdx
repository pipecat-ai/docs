...
description: "OpenAIRealtimeLLMService provides speech-to-speech conversation over the OpenAI Realtime API, replacing separate STT, LLM, and TTS."
---
...
<ParamField path="model" type="str" default="gpt-realtime-2.1" deprecated>
...
<Note>
  ...
  (`"gpt-realtime-2.1"` for model). Only parameters that are explicitly set are
  included.
</Note>
