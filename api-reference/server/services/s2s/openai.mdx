...
_Deprecated in v0.0.105. Use `settings=OpenAIRealtimeLLMService.Settings(model=...)` instead._
...
_Deprecated in v0.0.105. Use `settings=OpenAIRealtimeLLMService.Settings(session_properties=...)` instead._

</ParamField>

<ParamField
  path="settings"
  type="OpenAIRealtimeLLMService.Settings"
  default="None"
>
