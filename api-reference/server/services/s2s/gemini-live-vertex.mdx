...
description: "GeminiLiveVertexLLMService runs Gemini Live speech-to-speech conversation through Vertex AI with Google Cloud authentication."
---
...
<ParamField path="params" type="InputParams" default="InputParams()" deprecated>
  ...
  InputParams](/api-reference/server/services/s2s/gemini-live#settings) for details.
