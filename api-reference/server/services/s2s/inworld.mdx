...
description: "InworldRealtimeLLMService provides real-time multimodal conversation using Inworld's Realtime API for voice agents."
---
...
<ParamField path="llm_model" type="str" default="openai/gpt-4.1-mini">
  LLM model to use (e.g. "openai/gpt-4.1-mini"). Can be any supported model or
...
| Parameter           | Type                 | Default             | Description                                       |
| ------------------- | -------------------- | ------------------- | ------------------------------------------------- |
| `model`             | `str`                | `None`              | LLM model to use (e.g. "openai/gpt-4.1-mini").    |
