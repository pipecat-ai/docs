...
sidebarTitle: "Telnyx"
description: "TelnyxFrameSerializer integrates Pipecat with Telnyx's WebSocket media streaming protocol for telephony bots."
---
...
- **Custom transport messages**: The serializer passes through `OutputTransportMessageFrame` and `OutputTransportMessageUrgentFrame`, allowing custom application messages to be sent over the WebSocket connection.
