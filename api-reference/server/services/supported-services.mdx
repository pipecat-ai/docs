...
| [Gnani](/api-reference/server/services/stt/gnani)               | `uv add pipecat-gnani` or `"pipecat-ai[gnani]"`                               | Community  |
...
| [Gnani](/api-reference/server/services/tts/gnani)                 | `uv add pipecat-gnani` or `"pipecat-ai[gnani]"`                               | Community  |
