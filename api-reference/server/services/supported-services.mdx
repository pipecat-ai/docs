...
Classifiers answer typed questions about some state, such as whether a call reached voicemail or which element on screen the user means. See [Pipecat Classifiers](/pipecat/learn/classifiers).

| Classifier                                                 | Setup                      | Maintainer |
| ---------------------------------------------------------- | -------------------------- | ---------- |
| [Jev](/api-reference/server/classifiers/jev)               | `uv add "pipecat-ai[jev]"` | Pipecat    |
| [LLM](/api-reference/server/classifiers/llm)               | Built in                   | Pipecat    |
...
| [Memcode](/api-reference/server/services/memory/memcode)       | `uv add pipecat-memcode`       | Community  |
...
| [MCP](/api-reference/server/services/transport/mcp)                             | `uv add pipecat-mcp-transport`                | Community  |
