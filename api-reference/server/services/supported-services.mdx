...
| [Nebius](/api-reference/server/services/llm/nebius)                     | `pip install "pipecat-ai[nebius]"`     |
...
| [Inworld Realtime](/api-reference/server/services/s2s/inworld)                 | `pip install "pipecat-ai[inworld]"`        |
