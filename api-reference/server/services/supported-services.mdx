...
Backchannel services play short listening sounds while the user is still speaking, without taking a turn.

| Service                                                                               | Setup                        | Maintainer |
| ------------------------------------------------------------------------------------- | ---------------------------- | ---------- |
| [Pipecat Backchannel](/api-reference/server/services/backchannel/pipecat-backchannel) | `uv add pipecat-backchannel` | Community  |
