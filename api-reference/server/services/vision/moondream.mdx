...
sidebarTitle: "Moondream"
description: "MoondreamService runs local image analysis and visual question answering with the Moondream vision model."
---
...
<ParamField path="revision" type="str" default="2025-06-21">
