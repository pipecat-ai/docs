---
title: "SmolVLM Vision"
sidebarTitle: "SmolVLM"
description: "SmolVlmService runs HuggingFace SmolVLM vision-language models locally for image analysis in Pipecat pipelines."
---
...
```bash
# Core install
uv add pipecat-smolvlm

# With Flash Attention 2 (CUDA only — significant speedup)
uv add "pipecat-smolvlm[flash-attn]"

# Intel XPU support
uv add "pipecat-smolvlm[xpu]"
```
