---
title: "Pipecat Server API Overview"
sidebarTitle: "Overview"
description: "API reference for the Pipecat Python framework: pipelines, services, transports, utilities, and the server runtime."
---
...
<CardGroup cols={2}>
  ...
  <Card
    title="Frames"
    icon="layer-group"
    href="/api-reference/server/frames/overview"
  >
