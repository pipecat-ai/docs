---
title: "Bus Proxy Agents"
sidebarTitle: "Proxy Agents"
description: "WebSocketProxyClient and the bus proxy API: forward Pipecat bus messages to remote agents for distributed deployments."
---
