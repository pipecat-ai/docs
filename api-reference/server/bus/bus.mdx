...
In-process bus that delivers messages via priority queues. This is the default bus used by [`PipelineRunner`](/api-reference/server/workers/runner) when no bus is provided.
