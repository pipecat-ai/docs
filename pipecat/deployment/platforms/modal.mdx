---
title: "Modal"
description: "Deploy Pipecat voice agents to Modal: configuration, deployment steps, and running bots in production."
---
...
This guide walks through the Modal example included in the Pipecat repository. Architecturally it sits between the [VM-per-session](../patterns/vm-per-session) and [managed-runtime](../patterns/managed-runtime) patterns: a Modal Function plays the role of the per-session VM, but Modal manages the container lifecycle and image distribution for you.
