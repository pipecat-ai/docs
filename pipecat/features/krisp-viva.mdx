---
title: "Krisp VIVA"
description: "Integrate Krisp VIVA into Pipecat: voice isolation, noise filtering, and turn detection from the Krisp VIVA SDK."
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/api-reference/server/services/audio-filters/krisp-viva-filter"
  >
  ...
  <Card
    ...
    icon="code"
    href="/api-reference/server/utilities/turn-detection/krisp-viva-turn"
  >
  ...
  <Card
    ...
    icon="code"
    href="/api-reference/server/services/vad/krisp-viva-vad-analyzer"
  >
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/voice/voice-krisp-viva.py"
  >
