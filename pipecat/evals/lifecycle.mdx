...
| -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| The user path depends on realistic caller behavior       | Scripted turns prove one path while leaving user phrasing, interruptions, misunderstandings, and recovery behavior open                                           | Run simulated conversations with personas, edge cases, and adversarial behaviors                                               |
