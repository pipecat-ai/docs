...
<CardGroup cols={2}>
  ...
  >
    Audio and RTVI over QUIC, serving its own socket or dialing a relay
  </Card>
  <Card
    title="WhatsApp"
    icon="whatsapp"
...
<Tip>
  ...
  on the context aggregator instead of using the transport's turn_analyzer
  parameter.
</Tip>
...
<Card
  ...
  icon="arrow-right"
  href="/pipecat/learn/speech-input"
>
