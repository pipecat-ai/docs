---
title: "Proxy Agents"
description: "Connect Pipecat agents running on different buses with proxy agents, extending multi-agent pipelines across processes."
---
...
<Info>Install the WebSocket extra: `uv add "pipecat-ai[websocket]"`</Info>
