...
description: "Run Pipecat agents across processes and machines connected to the same bus for distributed multi-agent deployments."
---
...
<Note>
  ...
  Agents](/pipecat/learn/proxy-agents) instead.
</Note>
...
Distributed agents share one bus. When you need to connect agents across separate buses or networks, bridge them with a proxy.

<Card
  title="Proxy Agents"
  icon="arrow-right"
  href="/pipecat/learn/proxy-agents"
>
