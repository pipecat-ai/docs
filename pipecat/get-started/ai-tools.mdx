...
[Pipecat Context Hub](https://github.com/pipecat-ai/pipecat-context-hub) is a local-first MCP server that indexes Pipecat documentation, code examples, and framework API source on your machine. Your coding tool queries this index via MCP tools and gets back real code with source citations.
