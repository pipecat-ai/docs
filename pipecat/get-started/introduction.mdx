...
<Note>
  **Is Pipecat free?** Yes. The framework is free and open source (BSD-2
  license). You only pay for the AI services your agent uses (speech-to-text,
  LLM, and text-to-speech providers bill you directly) and for hosting: your
  own infrastructure or [Pipecat
  Cloud](https://www.daily.co/pricing/pipecat-cloud).
</Note>
