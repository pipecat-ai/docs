...
Proxy agents connect agents running on **different buses**. Unlike [distributed agents](/pipecat/agents/learn/distributed-agents) (which all share the same bus), proxy agents bridge two isolated bus instances point-to-point. This is useful when:
