---
title: "Migrating to Pipecat 1.0"
sidebarTitle: "Pipecat 1.0"
description: "Upgrade a Pipecat application from 0.0.x to 1.0: removed deprecated APIs, their replacements, and the migration path."
---
