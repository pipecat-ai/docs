...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/voice/kokoro.py"
  >
  ...
  <Card
    ...
    icon="gear"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/update-settings/tts/kokoro.py"
  >
