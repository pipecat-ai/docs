...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/07zj-interruptible-kokoro.py"
  >
  ...
  <Card
    ...
    icon="gear"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/55zg-update-settings-kokoro-tts.py"
  >
