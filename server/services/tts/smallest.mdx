...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/07zl-interruptible-smallest.py"
  >
...
Smallest AI TTS supports the standard [service connection events](/server/events/service-events):
