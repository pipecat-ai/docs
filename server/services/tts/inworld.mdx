...
<ParamField path="params" type="InputParams" default="None">
  Runtime-configurable synthesis settings. See [InworldTTSService InputParams](#inworldttsservice-inputparams) below.
</ParamField>
...
<ParamField path="params" type="InputParams" default="None">
  Runtime-configurable synthesis settings. See [InworldHttpTTSService InputParams](#inworldhttpttsservice-inputparams) below.
</ParamField>
