...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/voice/camb.py"
  >
...
<Tip>
  ...
  implementation](https://github.com/pipecat-ai/pipecat/blob/main/examples/voice/camb.py)
  for usage.
</Tip>
