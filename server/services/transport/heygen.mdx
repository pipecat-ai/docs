...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/43-heygen-transport.py"
  >
...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/43-heygen-transport.py) for a full implementation including:
