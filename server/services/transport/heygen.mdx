...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/heygen-transport.py"
  >
...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/heygen-transport.py) for a full implementation including:
