...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/56-lemonslice-transport.py"
  >
...
See the
[complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/56-lemonslice-transport.py)
...
- [Events Overview](/server/utilities/events) - Overview of all events in
  Pipecat
- [DailyTransport](/server/services/transport/daily) - Underlying Daily transport
  documentation
- [TransportParams](/server/services/transport/transport-params) - Base transport
  parameters
