...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/56-lemonslice-transport.py"
  >
...
See the
[complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/56-lemonslice-transport.py)
