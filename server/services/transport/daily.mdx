...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/transports/daily.py"
  >
...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/transports/daily.py) for a full implementation including:
