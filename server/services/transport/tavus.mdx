...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/tavus-video-service.py"
  >
...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/tavus-video-service.py) for a full implementation including:
