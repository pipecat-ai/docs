...
Cerebras provides ultra-fast inference for open-source language models through their custom AI chips. The service uses an OpenAI-compatible interface with streaming responses, function calling, and optimized performance for Llama models.

<CardGroup cols={3}>
  <Card
    title="API Reference"
    icon="code"
    href="https://pipecat-docs.readthedocs.io/en/latest/api/pipecat.services.cerebras.llm.html"
  >
