...
Fireworks AI provides fast inference for open-source language models with specialized function-calling models through an OpenAI-compatible API. The service offers high-performance model serving with competitive pricing and access to popular open-source models like Llama and Mixtral.

<CardGroup cols={3}>
  <Card
    title="API Reference"
    icon="code"
    href="https://pipecat-docs.readthedocs.io/en/latest/api/pipecat.services.fireworks.llm.html"
  >
