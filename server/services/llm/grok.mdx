...
<CardGroup cols={3}>
  <Card
    title="API Reference"
    icon="code"
    href="https://pipecat-docs.readthedocs.io/en/latest/api/pipecat.services.grok.llm.html"
  >
...
<Note>
  Grok uses incremental token reporting, so metrics are accumulated and reported
