...
Azure OpenAI provides access to OpenAI's language models through Microsoft's Azure platform with enhanced enterprise security, compliance, and regional availability. The service inherits full OpenAI compatibility while adding Azure-specific authentication and endpoint configuration.
