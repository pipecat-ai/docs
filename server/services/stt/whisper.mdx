...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/transcription/whisper.py"
  >
  ...
  <Card
    ...
    icon="microphone"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/transcription/whisper-mlx.py"
  >
