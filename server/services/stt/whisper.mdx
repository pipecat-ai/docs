...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/13-whisper-transcription.py"
  >
  ...
  <Card
    ...
    icon="microphone"
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/13e-whisper-mlx.py"
  >
