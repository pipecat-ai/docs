...
<ParamField path="model" type="str" required>
  Model to use for transcription. Find available models at [models.hathora.dev](https://models.hathora.dev).
</ParamField>
...
<ParamField path="base_url" type="str" default="https://api.models.hathora.dev/inference/v1/stt">
