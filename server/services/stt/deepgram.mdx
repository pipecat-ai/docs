...
- **Custom base URL schemes**: The `base_url` parameter respects your specified scheme (`ws://`, `wss://`, `http://`, `https://`). This is useful for air-gapped or private deployments where insecure schemes are acceptable. Bare hostnames default to secure schemes.
