...
| Spanish    | `es` | Spanish transcription    |
| French     | `fr` | French transcription     |
| German     | `de` | German transcription     |
| Italian    | `it` | Italian transcription    |
| Portuguese | `pt` | Portuguese transcription |
| Dutch      | `nl` | Dutch transcription      |
| Polish     | `pl` | Polish transcription     |
| Russian    | `ru` | Russian transcription    |
| Japanese   | `ja` | Japanese transcription   |
| Korean     | `ko` | Korean transcription     |
| Chinese    | `zh` | Chinese transcription    |
...
- **Speech Detection Events** - VAD-triggered metrics collection
