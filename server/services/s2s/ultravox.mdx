...
<ParamField path="params" type="AgentInputParams | OneShotInputParams | JoinUrlInputParams" required>
  Configuration parameters for connecting to Ultravox. One of three input parameter types must be provided. See [Input Parameter Types](#input-parameter-types) below.
</ParamField>
