...
| [LemonSliceTransport](/server/services/transport/lemonslice)              | `pip install "pipecat-ai[lemonslice]"` |
...
| [Genesys](/server/services/serializers/genesys) | No dependencies required |
...
| [Kokoro](/server/services/tts/kokoro)             | `pip install "pipecat-ai[kokoro]"`       |
...
| [NVIDIA](/server/services/tts/nvidia)             | `pip install "pipecat-ai[nvidia]"`       |
...
| Service                                            | Setup                              |
| -------------------------------------------------- | ---------------------------------- |
| [Azure](/server/services/image-generation/azure)   | `pip install "pipecat-ai[azure]"`  |
| [fal](/server/services/image-generation/fal)       | `pip install "pipecat-ai[fal]"`    |
| [Google](/server/services/image-generation/google) | `pip install "pipecat-ai[google]"` |
