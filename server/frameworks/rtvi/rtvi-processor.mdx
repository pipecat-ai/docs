...
The RTVIProcessor needs to be initialized with a configuration and added to your pipeline. The configuration defines what [services](https://docs.pipecat.ai/client/reference/js/services) and [configuration options](https://docs.pipecat.ai/client/reference/js/configuration) are available to clients.
...
<Tip>
  ...
  documentation](http://localhost:3000/client/reference/js/actions).
</Tip>
