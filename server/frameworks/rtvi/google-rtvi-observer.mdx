...
You'll also need to follow setup instructions for the [Google LLM Service](/server/services/llm/google#installation) to ensure the `GoogleLLMService` is properly configured.
