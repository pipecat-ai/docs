...
- **[StartupTimingObserver](/server/utilities/observers/startup-timing-observer)**: Measures processor startup times and transport readiness
- **[UserBotLatencyObserver](/server/utilities/observers/user-bot-latency-observer)**: Measures user-to-bot response latency
- **[TurnTrackingObserver](/server/utilities/observers/turn-tracking-observer)**: Tracks conversation turns and events
