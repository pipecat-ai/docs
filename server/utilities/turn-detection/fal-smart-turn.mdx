...
<Warning>
  ...
  [LocalSmartTurnAnalyzerV3](/server/utilities/turn-detection/smart-turn-overview#local-smart-turn)
...
<ParamField path="params" type="SmartTurnParams" default="SmartTurnParams()">
  ...
  [SmartTurnParams](/server/utilities/turn-detection/smart-turn-overview#configuration)
  for details.
</ParamField>
