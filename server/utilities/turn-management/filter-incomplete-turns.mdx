...
<ParamField path="filter_incomplete_user_turns" type="bool" default="False">
  ...
  system_instruction and configures the LLM service to process turn markers.
</ParamField>
...
- [Smart Turn Detection](/server/utilities/turn-detection/smart-turn-overview) - AI-powered end-of-turn detection
