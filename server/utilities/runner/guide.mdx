...
async def bot(session_args: RunnerArguments):
...
<Info>
  `RunnerArguments` is the base class for all session arguments. It provides a
...
**Session Arguments**: `SmallWebRTCRunnerArguments`
...
**Session Arguments**: `DailyRunnerArguments`
...
**Session Arguments**: `WebSocketRunnerArguments`
