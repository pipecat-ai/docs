...
For details on `UserTurnStoppedMessage` and `AssistantTurnStoppedMessage` fields, see [Turn Events - Message Types](/server/utilities/turn-events#message-types).

## Related

- [Turn Events](/server/utilities/turn-events) - Complete reference for turn lifecycle events
