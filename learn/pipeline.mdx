---
title: "Pipeline"
description: "Learn how to build and configure Pipecat pipelines to orchestrate your voice AI processing"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Metrics Guide" icon="chart-line" href="/guides/features/metrics">
