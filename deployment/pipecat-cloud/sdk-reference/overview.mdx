...
- [**Session Management**](/sdk-reference/sessions) - Start and interact with agent sessions
- [**Session Arguments**](/sdk-reference/session-arguments) - Types of arguments received by `bot()` entry points
- [**Error Handling**](/sdk-reference/exceptions) - Exception classes for handling different error scenarios
...
For more detailed examples and use cases, see the [Examples](/sdk-reference/examples) section.
