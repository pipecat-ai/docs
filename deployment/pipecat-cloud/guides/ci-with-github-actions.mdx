...
This guide shows you how to automate Pipecat Cloud deployments from GitHub Actions using your own container registry.

<Note>
  If you don't need your own container registry, [cloud builds](./cloud-builds)
  are the simpler option — no Docker, no registry setup. You can trigger cloud
  builds from GitHub Actions using the [CLI](../../../cli/cloud/build) or the
  [REST API](../rest-reference/endpoint/build-create).
</Note>
