...
<Info>
  ...
  `id`](/pipecat-in-production/telephony/daily-phone-numbers#list-all-purchased-phone-numbers)
  as the `callerId`.
</Info>
...
<Info>
  ...
  key](/accounts-and-organizations#api-keys), typically begins with "pk_..."
</Info>
