...
A ready-to-build example of a Plivo websockets bot with complete source code is available on our [Github](https://github.com/daily-co/pipecat-cloud-images/tree/main/pipecat-starters/plivo). Follow the steps to [build and deploy the image](https://docs.pipecat.daily.co/quickstart#deploy-the-agent).
