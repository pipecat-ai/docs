...
<Warning>
  Free Docker Hub accounts are limited to 100 image pulls per hour. If you are
  using a public Docker Hub image without authentication, your deployments may
  fail due to rate limiting. We recommend either [setting up image pull
  secrets](./secrets#image-pull-secrets) for Docker Hub or using a private
  container registry such as [AWS ECR](../guides/container-registries/aws-ecr)
  or [GCP Artifact
  Registry](../guides/container-registries/gcp-artifact-registry).
</Warning>
