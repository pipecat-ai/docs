...
<Card
  ...
  icon="play"
  href="/deployment/pipecat-cloud/quickstart"
>
...
<CardGroup cols={2}>
  <Card
    title="Agent Images"
    icon="box"
    href="/deployment/pipecat-cloud/fundamentals/agent-images"
  >
  ...
  <Card
    ...
    href="/deployment/pipecat-cloud/fundamentals/scaling"
  >
  ...
  <Card
    ...
    icon="phone"
    href="/deployment/pipecat-cloud/fundamentals/active-sessions"
  >
