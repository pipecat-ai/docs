...
This guide walks through the Modal example included in the Pipecat repository, which follows the same [deployment pattern](/deployment/overview/pattern).
...
<Frame>
  ...
  example](/deployment/images/modal.jpg)
</Frame>
