...
<Card
  ...
  icon="draw-square"
  iconType="duotone"
  href="/deployment/overview/pattern"
>
...
<CardGroup cols={2}>
  <Card
    title="Pipecat Cloud"
    icon="cloud"
    href="/deployment/overview/platforms/pipecat-cloud"
  >
  ...
  <Card
    title="Fly.io"
    icon="paper-plane"
    href="/deployment/overview/platforms/fly"
  >
    For service-driven / CPU bots
  </Card>
  <Card title="Modal" icon="rocket" href="/deployment/overview/platforms/modal">
    For running custom models on GPU-accelerated infrastructure
  </Card>
  <Card
    title="Cerebrium"
    icon="brain"
    href="/deployment/overview/platforms/cerebrium"
  >
