...
1. **Build from the base image** - Create a custom agent using the official base image
2. **Use example projects** - Reference implementations from [pipecat-quickstart](https://github.com/pipecat-ai/pipecat-quickstart) or [pipecat-examples](https://github.com/pipecat-ai/pipecat-examples)

<Warning>
  **Starter templates are deprecated** and will be removed after October 15,
  2025. Use
  [pipecat-quickstart](https://github.com/pipecat-ai/pipecat-quickstart) or
  [pipecat-examples](https://github.com/pipecat-ai/pipecat-examples) instead.
</Warning>

## Project structure

A basic Pipecat Cloud project typically includes:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="https://github.com/pipecat-ai/pipecat-quickstart"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="phone"
    href="../pipecat-cloud/fundamentals/active-sessions"
  >
