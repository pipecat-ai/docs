...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/context-summarization/manual-openai.py) for a full working implementation.
