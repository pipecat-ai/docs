...
See the [complete example](https://github.com/pipecat-ai/pipecat/blob/main/examples/54b-context-summarization-manual-openai.py) for a full working implementation.
