...
Flows comes equipped with pre-canned actions and you can also define your own action behavior. See the [reference docs](/server/frameworks/flows/pipecat-flows#built-in-actions) for more information.
