...
Flows comes equipped with built-in actions and you can define your own custom actions. See the [reference docs](/server/frameworks/flows/pipecat-flows#built-in-actions) for more information.
