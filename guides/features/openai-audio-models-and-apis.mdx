...
A cascaded pipeline looks like this, in Pipecat code. Here's a [single-file example that uses a cascaded pipeline](https://github.com/pipecat-ai/pipecat/blob/main/examples/07g-interruptible-openai.py). (See below for an overview of Pipecat core concepts.)
...
Here's a speech-to-speech pipeline in Pipecat code. And here's a [single-file example that uses the OpenAI Realtime API](https://github.com/pipecat-ai/pipecat/blob/main/examples/19-openai-realtime-beta.py).
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="https://github.com/pipecat-ai/pipecat/blob/main/examples/19-openai-realtime-beta.py"
  >
