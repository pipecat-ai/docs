...
This guide walks through the Modal example included in the Pipecat repository, which follows the same deployment patter mentioned [previously](http://localhost:3000/deployment/pattern).
...
<Frame>
  ![Diagram of the deployment architecture of Modal and Pipecat example](images/modal.jpg)
</Frame>

## Install the Modal CLI

You can find instructions for creating and setting up your Modal account [here](https://modal.com/docs/guide#getting-started).
...
5. Jot down the endpoint from the previous step to use in the client's app.js file mentioned in its README. It will look something like: `https://<Modal workspace>--pipecat-modal-fastapi-app.modal.run`
