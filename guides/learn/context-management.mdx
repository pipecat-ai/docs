...
You can also manually trigger context summarization at any point by replacing the context with a compressed version using `LLMMessagesUpdateFrame`. This is useful when you need precise control over when summarization happens rather than relying on automatic thresholds.
...
>
  Learn how to configure automatic and manual summarization, customize behavior,
  and control what gets preserved.
</Card>
