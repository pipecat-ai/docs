...
When no image is specified, the CLI will offer to build your agent using [Pipecat Cloud Build](/deployment/pipecat-cloud/guides/cloud-builds). This handles Dockerfile generation, building, and deploying without requiring you to manage a container registry.
...
<ParamField path="--dockerfile" type="string">
  ...
  context directory. If no Dockerfile exists, the CLI will offer to generate
  one automatically.
</ParamField>
