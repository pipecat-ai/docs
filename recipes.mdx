...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/14-function-calling.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/34-audio-recording.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/28-transcription-processor.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/23-bot-background-sound.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/24-stt-mute-filter.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/10-wake-phrase.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/11-sound-effects.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/15a-switch-languages.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/17-detect-user-idle.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/30-observer.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/36-user-email-gathering.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/38b-smart-turn-local.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/39-mcp-stdio.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/39a-mcp-streamable-http.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/39c-multiple-mcp.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/42-interruption-config.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/12b-describe-video-gpt-4o.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/29-turn-tracking-observer.py)
