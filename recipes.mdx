...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/user-assistant-turns.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/audio/bot-background-sound.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/user-mute-strategy.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/features/wake-phrase.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/audio/sound-effects.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/features/switch-languages.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/detect-user-idle.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/observability/observer.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/features/user-email-gathering.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/smart-turn-local.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/thinking-and-mcp/mcp-stdio.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/thinking-and-mcp/mcp-streamable-http.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/thinking-and-mcp/multiple-mcp.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/interruption-config.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/vision/openai.py)
...
[View Recipe →](https://github.com/pipecat-ai/pipecat/blob/main/examples/turn-management/turn-tracking-observer.py)
