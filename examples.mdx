...
[View Quickstart Guide →](/getting-started/quickstart)
...
[View Example →](https://github.com/pipecat-ai/pipecat/blob/main/examples/features/voicemail-detection.py)
...
[View Example →](https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/tavus-video-service.py)
...
[View Example →](https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/heygen-video-service.py)
...
[View Example →](https://github.com/pipecat-ai/pipecat/blob/main/examples/video-avatar/simli-layer.py)
