...
<Update label={<><Icon icon="laptop-mobile" size={16} color="currentColor" /><span style={{marginLeft: '8px'}}>Web Quickstart</span></>} tags={["Getting Started", "Web & Mobile"]}>

Quickstart demo for a basic web bot.

[View Example →](https://github.com/pipecat-ai/pipecat-quickstart-client-server)

</Update>

<Update label={<><Icon icon="phone" size={16} color="currentColor" /><span style={{marginLeft: '8px'}}>Phone Quickstart</span></>} tags={["Getting Started", "Telephony"]}>

Quickstart demo for a basic phone bot using Twilio.

[View Example →](https://github.com/pipecat-ai/pipecat-quickstart-phone-bot)
