...
Use `FlowsAgent` when you need deterministic conversation paths -- like booking flows, intake forms, or multi-step processes -- that would be hard to control with a free-form LLM prompt.
