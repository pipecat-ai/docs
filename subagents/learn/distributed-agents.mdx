...
<Note>
  Distributed agents share a bus. If you need to connect agents on **different buses** (separate networks, third-party services), see [Proxy Agents](/subagents/learn/proxy-agents) instead.
</Note>
