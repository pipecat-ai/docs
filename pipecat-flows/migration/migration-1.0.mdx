---
title: "Migrating to Pipecat Flows 1.0"
sidebarTitle: "Migrating to 1.0"
description: "Upgrade a Pipecat Flows application from 0.0.x to 1.0: removed deprecated APIs, replacements, and the migration path."
---
