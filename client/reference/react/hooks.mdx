...
Provides access to the PipecatClient instance originally passed to RTVIClientProvider.

```jsx
import { useRTVIClient } from "@pipecat-ai/pipecat-react";

function MyComponent() {
  const pipecatClient = useRTVIClient();
}
```
...
import { RTVIEvent, TransportState } from "@pipecat-ai/pipecat-js";
import { useRTVIClientEvent } from "@pipecat-ai/pipecat-react";
...
```jsx
import { useRTVIClientMediaDevices } from "@pipecat-ai/pipecat-react";
...
```jsx
import { useRTVIClientMediaTrack } from "@pipecat-ai/pipecat-react";
...
```jsx
import { useRTVIClientTransportState } from "@pipecat-ai/pipecat-react";
