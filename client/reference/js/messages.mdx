...
Developers can build their own messages and create handlers to respond to messages received from a bot either by extending `PipecatClient` with their own class or by building a [helper](./helpers/introduction).
