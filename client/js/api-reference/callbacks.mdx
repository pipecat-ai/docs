...
<ParamField path="onBotLlmSearchResponse" type="BotLLMSearchResponseData">
  ...
  <Warning>
    ...
    should include the
    [`GoogleRTVIObserver`](/api-reference/server/frameworks/rtvi/google-rtvi-observer) in lieu
...
<ParamField path="onLLMFunctionCallStarted" type="LLMFunctionCallStartedData">
  ...
  on the server's [`function_call_report_level`](/api-reference/server/frameworks/rtvi/rtvi-observer#configuration) configuration.
