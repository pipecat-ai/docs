---
title: "Pipecat Enterprise on Oracle OKE"
...
As on EKS, the region's values file is generated from the infrastructure's outputs — front door, agent placement, monitors — and your own tuning is layered after it. It carries no image references or versions, so [upgrades stay version-only](/pipecat-cloud/enterprise/operations#upgrading-the-region-package).
