---
title: "Pipecat Enterprise Secrets"
...
<Steps>
  ...
  <Step title="Use it in a deployment">
    ...
    ```bash
    pipecat cloud deploy --region pce-acme-us-east --secrets my-agent-secrets
    ```
...
pipecat cloud secrets reference my-registry-creds --region pce-acme-us-east
```
