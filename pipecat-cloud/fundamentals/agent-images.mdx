---
title: "Pipecat Cloud Agent Images"
sidebarTitle: "Agent Images"
description: "Containerize a Pipecat agent for Pipecat Cloud: Dockerfile structure, base images, and image build requirements."
---
...
The base image supports multiple Python versions. The default Python version is 3.12.

<Warning>
  Python 3.10 base images are deprecated and will be removed in a future
  release. Upgrade to Python 3.11 or later.
</Warning>

**Latest tags:**

- `dailyco/pipecat-base:latest` (Python 3.12, default)
- `dailyco/pipecat-base:latest-py3.10` (Python 3.10, deprecated)
...
- `dailyco/pipecat-base:latest-py3.14` (Python 3.14)

**Versioned tags:**

- `dailyco/pipecat-base:0.1.0` (Python 3.12, default)
- `dailyco/pipecat-base:0.1.0-py3.10` (Python 3.10, deprecated)
...
<Note>
  If you're using [cloud builds](/pipecat-cloud/guides/cloud-builds), you only
