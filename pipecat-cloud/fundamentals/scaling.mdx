...
<Note>
  ...
  of 50. Please contact us at help@daily.co or via
  [Discord](https://discord.gg/dailyco) if you require more capacity. This limit
  does not apply to [self-hosted
  regions](/pipecat-cloud/self-hosted/sizing#scaling-limits), where pool size is
  bounded only by your cluster's capacity.
</Note>
