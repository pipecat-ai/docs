...
| `unknown` | Readiness could not be verified because the region was unreachable. Applies to [referenced secrets](/enterprise/secrets) in self-hosted regions; retry shortly. |
...
in a [self-hosted region](/enterprise/secrets).
...
<Note>
  ...
  [reference it](/enterprise/secrets) instead.
</Note>
