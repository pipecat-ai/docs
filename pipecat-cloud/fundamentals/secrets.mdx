...
| `unknown` | Readiness could not be verified because the region was unreachable. Applies to [referenced secrets](/pipecat-cloud/enterprise/secrets) in self-hosted regions; retry shortly. |
...
in a [self-hosted region](/pipecat-cloud/enterprise/secrets).
...
<Note>
  ...
  [reference it](/pipecat-cloud/enterprise/secrets) instead.
</Note>
