...
<Note>
  For agents in a [self-hosted region](/pipecat-cloud/enterprise/overview), logs
  are stored in your own region and log collection is off by default. See
  [Pipecat Enterprise Logs](/pipecat-cloud/enterprise/logs).
</Note>
