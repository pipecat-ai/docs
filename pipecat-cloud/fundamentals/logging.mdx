---
title: "Pipecat Cloud Logging and Observability"
sidebarTitle: "Logging and Observability"
description: "Obtain logs and metrics from Pipecat Cloud agents and sessions for debugging, monitoring, and production observability."
---
...
<Note>
  For agents in a [self-hosted region](/pipecat-cloud/self-hosted/overview),
  logs are stored in your own region and log collection is off by default. See
  [Self-Hosted Region Logs](/pipecat-cloud/self-hosted/logs).
</Note>
