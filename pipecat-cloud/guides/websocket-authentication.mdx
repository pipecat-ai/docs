...
The `wsUrl` from the `/start` response points to the [generic WebSocket endpoint](/pipecat-cloud/guides/telephony/generic-websocket). The token can be provided in three ways, checked in this order:
