...
Or via the [REST API](/pipecat-cloud/rest-reference/endpoint/regions-list).
...
You can specify a default region for your organization via the [REST API](/pipecat-cloud/rest-reference/endpoint/properties-update) or the [CLI](/cli/cloud/organizations#default-region). If you don't specify a region, resources are created in your organization's default region.
