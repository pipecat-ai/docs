...
<Note>
  ...
  support, see the [CI with GitHub
  Actions](/pipecat-cloud/guides/ci-with-github-actions) guide.
</Note>
...
See the [deploy command reference](/api-reference/cli/cloud/deploy#configuration-file-pcc-deploy-toml) for the full list of configuration options.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="warehouse"
    href="/pipecat-cloud/guides/container-registries/overview"
  >
    Use your own container registry for advanced image management.
  </Card>
  <Card
    title="Build CLI Reference"
    icon="terminal"
    href="/api-reference/cli/cloud/build"
  >
