---
title: "Pipecat Cloud Container Registries"
sidebarTitle: "Overview"
description: "Deploy Pipecat Cloud agents from private container registries: supported registries, image pull credentials, and setup guides."
---

<Tip>
  Don't need your own registry? [Cloud
  builds](/pipecat-cloud/guides/cloud-builds) let you deploy directly from
  source with `pipecat cloud deploy` — no registry setup required.
</Tip>
