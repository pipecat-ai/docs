---
title: "Deploy from GCP Artifact Registry"
sidebarTitle: "GCP Artifact Registry"
description: "Deploy Pipecat Cloud agents from Google Cloud Artifact Registry: service account keys, image paths, and pull configuration."
---
