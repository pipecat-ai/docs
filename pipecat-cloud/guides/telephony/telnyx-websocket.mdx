---
title: "Telnyx WebSockets on Pipecat Cloud"
sidebarTitle: "Telnyx Websocket Transport"
description: "Receive Telnyx phone calls in Pipecat Cloud agents over WebSocket media streaming: TeXML setup, serializers, and configuration."
---
...
<Note>
  ...
  guide](/pipecat/telephony/telnyx-websockets).
</Note>
...
For complete implementation details including dial-out, caller personalization, custom parameters, and advanced call control features, see the [Telnyx WebSocket Integration guide](/pipecat/telephony/telnyx-websockets).
