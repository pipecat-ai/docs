---
title: "Daily PSTN Dial-out on Pipecat Cloud"
sidebarTitle: "Daily PSTN Dial-out"
description: "Place outbound calls to PSTN numbers and SIP addresses from Pipecat Cloud agents using Daily's transport and dial-out config."
---
...
| `dial-out to PhoneNumber is not enabled for domain. Contact support to enable it for your domain` | Your Daily domain is not approved for dial-out to phone numbers. | Fill out the [dial-out request form](https://docs.google.com/forms/d/e/1FAIpQLSe3hTnIchbS1NgOsO8HGrzyBk5B1WuwWT_qqfNQde14_L-Y_Q/viewform). Only `+` destinations are gated; `sip:` URIs are not. |
...
<Note>
  ...
  key in use — the Pipecat Cloud-provisioned one, or your own if you bring a
  key. Make sure telephony is enabled on that account.
</Note>
