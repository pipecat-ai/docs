---
title: "Pipecat Cloud CI with GitHub Actions"
sidebarTitle: "CI with GitHub Actions"
description: "Automate Pipecat Cloud builds and deploys from CI using the official pipecat-ai GitHub Action in your workflow."
---
