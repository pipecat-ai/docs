---
title: "Pipecat Cloud Generic WebSocket"
sidebarTitle: "Generic WebSocket"
description: "Connect any WebSocket client to Pipecat Cloud agents: telephony providers, server-to-server links, or custom integrations."
---
