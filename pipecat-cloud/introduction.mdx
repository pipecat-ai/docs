---
title: "Introduction to Pipecat Cloud"
sidebarTitle: "Introduction"
description: "Pipecat Cloud is managed infrastructure for deploying and scaling Pipecat voice agents to production, run by the Pipecat team."
---
...
- **Self-hosted regions**: Run agents in your own cluster while Pipecat Cloud stays the control plane — part of [Pipecat Enterprise](/pipecat-cloud/self-hosted/overview)
