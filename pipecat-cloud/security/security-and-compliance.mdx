---
title: "Pipecat Cloud Security Guide"
sidebarTitle: "Security Guide"
description: "Secure Pipecat Cloud agents: platform security model, compliance posture, and hardening recommendations for deployments."
---
...
Your agents run in the [region](/pipecat-cloud/guides/regions) you deploy them to. Pipecat Cloud currently offers regions in the US West (Oregon), US East (Virginia), Europe (Frankfurt), and Asia Pacific (Mumbai). Agents execute, and their logs are stored, in the agent's region; account, billing, session records, and other control-plane data are stored in the US. Contact us at `help@daily.co` if you have specific data residency requirements.
