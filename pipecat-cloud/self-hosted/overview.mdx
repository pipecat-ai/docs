...
<Note>
  ...
  organization, [contact Daily](/pipecat-cloud/support).
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Agent Images"
    icon="box"
    href="/pipecat-cloud/fundamentals/agent-images"
  >
  ...
  <Card title="Secrets" icon="key" href="/pipecat-cloud/fundamentals/secrets">
    ...
    secrets](/pipecat-cloud/self-hosted/secrets).
  </Card>
  <Card
    title="Scaling"
    icon="arrows-up-down"
  ...
  <Card
    title="Session API"
    icon="code"
    href="/pipecat-cloud/guides/session-api"
  >
...
<Steps>
  <Step title="Get enabled">
    ...
    us](/pipecat-cloud/support) to get started.
  </Step>
