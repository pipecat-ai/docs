...
- **A conforming Kubernetes cluster, version 1.29 or later.** Any distribution works — managed (EKS, GKE, AKS, OKE) or self-managed. The [reference architectures](/pipecat-cloud/self-hosted/reference/aws-eks) for AWS EKS and Oracle OKE are proven layouts.
