...
<Note>
  **Is Pipecat free?** Yes. The Pipecat framework is free and open source
  (BSD-2 license), and there is no charge to use it. Your costs come from two
  places: the AI services your agent calls (speech-to-text, LLM, and
  text-to-speech providers bill you directly) and hosting, either your own
  infrastructure or [Pipecat
