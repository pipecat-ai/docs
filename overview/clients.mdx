---
title: "Pipecat Client SDKs"
sidebarTitle: "Pipecat Clients"
description: "The Pipecat client SDK family connects users to your agents from web and mobile apps, handling the real-time media layer."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Pipecat UI" icon="palette" href="/client/pipecat-ui">
    Customizable React components for voice AI interfaces, installed as source.
  </Card>
</CardGroup>
