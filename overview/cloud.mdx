---
title: "Pipecat Cloud"
description: "Pipecat Cloud is the managed hosting platform for deploying and scaling Pipecat agents, from the team behind the framework."
---
...
<CardGroup cols={2}>
  <Card title="Get Started" icon="rocket" href="/pipecat-cloud/introduction">
