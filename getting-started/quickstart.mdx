...
The CLI automatically builds your image using the Dockerfile in your project and deploys it to Pipecat Cloud — no container registry needed.
...
async def on_client_connected(transport, client):
    ...
    context.append_message("user", "Say hello and briefly introduce yourself.")
