...
### 1. Create your project directory and get the files

Create a new directory for your project:

```bash
mkdir pipecat-quickstart
cd pipecat-quickstart
```

Download the quickstart files:

```bash
curl -o bot.py https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/quickstart/bot.py
curl -o requirements.txt https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/quickstart/requirements.txt
curl -o env.example https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/quickstart/env.example
```

<Info>
  **Alternative method**: You can also visit the [quickstart folder on
  GitHub](https://github.com/pipecat-ai/pipecat/tree/main/examples/quickstart)
...
- **Learn client/server architecture**: Try the [Client/Server Web example](https://github.com/pipecat-ai/pipecat/tree/main/examples/client-server-web) to learn how to build custom web interfaces
- **Connect to a phone**: Explore the [Phone Bot Twilio example](https://github.com/pipecat-ai/pipecat/tree/main/examples/phone-bot-twilio) to make your bot callable
