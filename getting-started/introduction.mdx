...
The framework handles the orchestration of AI services, network transports, audio processing, and multimodal interactions, enabling ultra-low latency interactions that feel natural and conversational. Build everything from simple voice assistants to complex multimodal applications that combine audio, video, images, and text.
...
<Card
  ...
  icon="gamepad"
  href="https://github.com/pipecat-ai/pipecat/tree/main/examples/word-wrangler-gemini-live"
>
