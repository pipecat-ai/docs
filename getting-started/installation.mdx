...
- [Daily.co](https://dashboard.daily.co/u/signup?pipecat=true) for your transport layer. Daily uses WebRTC to exchange real-time audio and video between the bot and the user.
...
<AccordionGroup>
  <Accordion title="ElevenLabs">
    ...
    DAILY_API_KEY=your_daily_api_key ELEVENLABS_API_KEY=your_elevenlabs_api_key
  ...
  <Accordion title="Cartesia">
    ...
    ```env
    DAILY_SAMPLE_ROOM_URL=https://YOURDOMAIN.daily.co/YOURROOM
    DAILY_API_KEY=your_daily_api_key CARTESIA_API_KEY=your_cartesia_api_key
  ...
  <Accordion title="Deepgram">
    ...
    ```env
    DAILY_SAMPLE_ROOM_URL=https://YOURDOMAIN.daily.co/YOURROOM
    DAILY_API_KEY=your_daily_api_key DEEPGRAM_API_KEY=your_deepgram_api_key
