...
- [Daily](https://dashboard.daily.co/u/signup?pipecat=true) for your transport layer. Daily uses WebRTC to exchange real-time audio and video between the bot and the user.
