...
```bash
mkdir pipecat-phone-bot
cd pipecat-phone-bot
```

Download the phone bot files:

```bash
curl -o bot.py https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/phone-bot-twilio/bot.py
curl -o requirements.txt https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/phone-bot-twilio/requirements.txt
curl -o env.example https://raw.githubusercontent.com/pipecat-ai/pipecat/main/examples/phone-bot-twilio/env.example
```

<Info>
  **Alternative method**: You can also visit the [phone-bot-twilio folder on
  GitHub](https://github.com/pipecat-ai/pipecat/tree/main/examples/phone-bot-twilio)
