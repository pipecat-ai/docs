...
<Card
  ...
  icon="code"
>
  We have cloneable starter projects available
  [here](https://github.com/pipecat-ai/pipecat/tree/main/examples/dialin-chatbot)
</Card>
